...
public class Magus extends Agent implements Persistent {
    ...
    public Magus(World world) {
        this(new Location(world), new MagusBaseDecider(), world);
    }
    ...
    public int getLabTotal(Arts technique, Arts form, List<Magus> assistants) {
        if (hasApprentice() && getLevelOf(Abilities.LEADERSHIP) >= assistants.size() && !assistants.contains(apprentice))
            assistants.add(apprentice);
    ...
    public int getCommunication() {
        return communication.getModifier();
    }

    public int getPresence() {
        return presence.getModifier();
    }

    public int getQuickness() {
        return quickness.getModifier();
    }

    public ArsMagicaCharacteristic getIntelligenceAMC() {
        return intelligence;
    }

    public ArsMagicaCharacteristic getPerceptionAMC() {
        return perception;
    }

    public ArsMagicaCharacteristic getStrengthAMC() {
        return strength;
    }

    public ArsMagicaCharacteristic getStaminaAMC() {
        return stamina;
    }

    public ArsMagicaCharacteristic getDexterityAMC() {
        return dexterity;
    }

    public ArsMagicaCharacteristic getCommunicationAMC() {
        return communication;
    }

    public ArsMagicaCharacteristic getPresenceAMC() {
        return presence;
    }

    public ArsMagicaCharacteristic getQuicknessAMC() {
        return quickness;
    }

    public void setIntelligence(int value) {
        intelligence.setModifier(value);
    }

    public void setPerception(int value) {
        perception.setModifier(value);
    }

    public void setStrength(int value) {
        strength.setModifier(value);
    }

    public void setStamina(int value) {
        stamina.setModifier(value);
    }

    public void setDexterity(int value) {
        dexterity.setModifier(value);
    }

    public void setCommunication(int value) {
        communication.setModifier(value);
    }

    public void setPresence(int value) {
        presence.setModifier(value);
    }

    public void setQuickness(int value) {
        quickness.setModifier(value);
    }
    ...
    public Arts getTypeOfVisToStudy() {
        ...
        List<Vis> longevityRequirements = InventLongevityRitual.requirementsForRitual(this);
        vis.put(Arts.CREO, vis.get(Arts.CREO) - AMU.pawnsOfVisIn(longevityRequirements, Arts.CREO));
        vis.put(Arts.CORPUS, vis.get(Arts.CORPUS) - AMU.pawnsOfVisIn(longevityRequirements, Arts.CORPUS));
        vis.put(Arts.VIM, vis.get(Arts.VIM) - AMU.pawnsOfVisIn(longevityRequirements, Arts.VIM));
        int magicTheory = getLevelOf(Abilities.MAGIC_THEORY);
        Map<Learnable, Double> options = new HashMap<Learnable, Double>();
    ...
    public Set<Learnable> getPossibleTractactusSubjects() {
        ...
        for (Learnable skill : skills.keySet()) {
            int levelsPerTractatus = (skill instanceof Abilities) ? 2 : 5;
            ...
            int writtenSoFar = tractatusWritten.getOrDefault(skill, 0);
            if (getLevelOf(skill) < (writtenSoFar + 1) * levelsPerTractatus)
